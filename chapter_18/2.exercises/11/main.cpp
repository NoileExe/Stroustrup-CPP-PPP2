...
int main()
{
	while (true) {
		try
		{
			cout << "Enter the characters for next Skip_list gen. CTRL+Z for end test\n\n";
			...
			cout << "Enter the characters. CTRL+Z for end test\n\n";
